...
Loosen the 8 buried screws at the top of the vertical extrusions and take the top square out. The top corner pieces will keep the square in one piece. Unfasten two corners (total 4 screws) to break the square into an `U` and an `I`. 
