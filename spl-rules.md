...
The **Design Award** recognizes the team whose ROBOT best demonstrates a balance of **form, function, and aesthetics** — applied to this season's challenge. The award evaluates the **robot as a whole** and the **design process** behind it.
...
3. **Trade-off awareness.** The team can articulate trade-offs they accepted (e.g., speed vs. precision, complexity vs. reliability) and explain why.
...
7. **Elegance, efficiency, and maintainability.** The robot is simple where it can be, executes its function reliably, and is practical to service, repair, and adjust between matches.
